module.exports = {
    ...
    async createHTML() {
        ...
        await this.createDataPoint(`html.trigger_iqontrol`, common, "state", null, null);
        common = {
            type: "boolean",
            role: "switch",
            name: {
        ...
        await this.createDataPoint(`html.trigger`, common, "state", null, null);
        common = {
            type: "string",
            role: "state",
            name: {
        ...
        common = {
            ...
            desc: "Image widtht on weather forecast",
            read: true,
            write: true,
            unit: "px",
            def: 30,
